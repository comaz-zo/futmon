...
include('./conecofor_menu_class.php');
...
$conecofor_menu_obj = new conecofor_menu_class();
...
<tbody>
	...
	<tr>
		<td colspan="3" style="width: 60px; height: 40px; vertical-align: top;  background-color: rgb(72, 81, 83);">
			<img src="images/corner_ul.gif" alt="" style="width: 40px; height: 40px;" align="top">
		</td>
		<td style="color: white; text-align: left; vertical-align: center; background-color: rgb(72, 81, 83); height: 40px;">
	...
	<tr>
		...
		<td colspan="2" style="vertical-align: top; width: 40px; background-color: rgb(181, 201, 207);">
			<img src="images/corner_green_ul.gif" alt="" style="width: 20px; height: 20px;" align="top">
		</td>
		<td style="text-align: left; vertical-align: top; background-color: rgb(181, 201, 207); height: 20px;">
			<?php $conecofor_menu_obj->print_title(); ?>
		</td>
	</tr>
	<tr>
		<td style="width: 20px; background-color: rgb(72, 81, 83);">
		...
		<td style="vertical-align: top;"><br>
			<?php $conecofor_menu_obj->print_menu_form(); ?>
		</td>
	</tr>
</tbody>
</table>
