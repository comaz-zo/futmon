...
include('./conecofor_admin_export_raw_data_class.php');
...
$conecofor_export_raw_data_obj = new conecofor_export_raw_data_class();
...
<tbody>
	...
	<tr>
		...
		<td style="text-align: left; vertical-align: top; background-color: rgb(181, 201, 207); height: 20px;">
			<?php $conecofor_export_raw_data_obj->print_title(); ?>
		</td>
	</tr>
	<tr>
		<td style="width: 20px; background-color: rgb(72, 81, 83);">
		...
		<td style="vertical-align: top;"><br>
			<?php $conecofor_export_raw_data_obj->print_form(); ?>
		</td>
	</tr>
</tbody>
</table>
