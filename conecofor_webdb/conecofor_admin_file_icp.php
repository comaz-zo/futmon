...
include('./conecofor_admin_file_icp_class.php');
...
$conecofor_file_icp_obj = new conecofor_file_icp_class();
...
<tbody>
	...
	<tr>
		...
		<td style="text-align: left; vertical-align: top; background-color: rgb(181, 201, 207); height: 20px;">
			<?php $conecofor_file_icp_obj->print_title(); ?>
		</td>
	</tr>
	<tr>
		<td style="width: 20px; background-color: rgb(72, 81, 83);">
		...
		<td style="vertical-align: top;"><br>
			<?php $conecofor_file_icp_obj->print_form(); ?>
		</td>
	</tr>
</tbody>
</table>
