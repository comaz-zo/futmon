...
include('./conecofor_admin_manage_user_class.php');
...
$conecofor_manage_obj = new conecofor_manage_class();
...
<tbody>
	...
	<tr>
		...
		<td style="text-align: left; vertical-align: top; background-color: rgb(181, 201, 207); height: 20px;">
			<?php $conecofor_manage_obj->print_title(); ?>
		</td>
	</tr>
	<tr>
		<td style="width: 20px; background-color: rgb(72, 81, 83);">
		...
		<td style="vertical-align: top;"><br>
			<?php $conecofor_manage_obj->print_form(); ?>
		</td>
	</tr>
</tbody>
</table>
